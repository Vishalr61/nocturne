...
// Order = the popover strip, Original first (it is also the default: a book
// opens exactly as published, then you choose a look), lights before darks.
...
export const DEFAULT_THEME = THEMES[0] // Original — a new book opens as published
